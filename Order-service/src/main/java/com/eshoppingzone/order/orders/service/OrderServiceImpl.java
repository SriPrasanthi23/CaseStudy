...
public class OrderServiceImpl implements OrderService {
	...
	public void placeOrder(Cart cart,String mode,String fullName) {
		...
		orderRepository.save(order);
		 ...
		 restTemplate.delete("http://cart-service/cart/delete/"+cart.getId());
	...
	public Orders getOrderById(int orderId) {
	  ...
	  @Override public String onlinePayment(Cart cart) throws RazorpayException {
	  
	  double amt= cart.getTotalPrice(); System.out.println(amt);
	  
	  RazorpayClient client = new
	  RazorpayClient("rzp_test_i2jPtH1FE7nbR","mXXogKZrIcGkW2fvjwchytyh" );
